...
class _TaskAsignTabletState extends State<TaskAsignTablet>{
    ...
    Container elementBox(Size screenSize,String text,Color myColor, EdgeInsetsGeometry pad){
     ...
     Container searchResult(Size screenSize,String search){
      ...
      List<String> alumnosFilt=alumnos.where(
        (element) => element.
                    toLowerCase().
                    contains(
                      search.toLowerCase()
      ...
      return Container(
        ...
        child: ItemListWidget(elements: alumnosFilt,onItemTap: (name){
                              ...
                              SizedBox(
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Row(
                                    children: [
                                      // Foto
                                      Padding(padding: const EdgeInsets.all(20),child: Image.asset("assets/images/alonso.png",height: screenSize.height*0.2,)),
